...
public class MessageController implements CommunityConstant {
    ...
    public String getNoticeList(Model model){
        ...
        if(message != null){
            ...
            //数据库里通知的内容{&quot;entityType&quot;:3,&quot;entityId&quot;:146,&quot;userId&quot;:154}  &quot需要反转一下
            String content = HtmlUtils.htmlUnescape(message.getContent());//现在就是正常字符串了  接下来要转为对象
            Map<String,Object> data =JSONObject.parseObject(content,HashMap.class);//对象类型为HashMap

            messageVO.put("user",userService.findUserById((Integer) data.get("userId")));//从data对象中取userId 从而找到user
